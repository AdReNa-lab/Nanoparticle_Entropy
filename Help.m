...
function Help_OpeningFcn(hObject, ~, handles, varargin)

handles.output = hObject;
ax = handles.axes1;
set(ax,'visible', 'off');
help_overview = imread('ML2.png','png');
...
function varargout = Help_OutputFcn(~, ~, handles) 
...
switch handles.counter
    case 2
        ax = handles.axes1;
        set(ax,'visible', 'off');
        help_overview = imread('ML3.png','png');
        imshow(help_overview, 'parent', ax);
    ...
    case 3
        ax = handles.axes1;
        set(ax,'visible', 'off');
        help_overview = imread('ML4.png','png');
        imshow(help_overview, 'parent', ax);
